...
export function Register() {
  ...
  async function handleSubmit(e) {
    ...
    if (!termsAccepted) {
      setError(
        'Трябва да приемете Общите условия и Политиката за поверителност, за да продължите.'
      )
      return
    }
  ...
  if (registrationSent) {
    return (
      <div className="auth-shell">
        ...
        <p>
          *Ако не намерите получения имейл, проверете в папка СПАМ!
        </p>
      </div>
    )
  }
    ...
    <div className="auth-shell">
      ...
      <form onSubmit={handleSubmit}>
          ...
          <>
            ...
            >
              <svg viewBox="0 0 24 24">
                ...
                <path
                  fill="#FBBC05"
                  d="M5.84 14.09A6.6 6.6 0 0 1 5.48 12c0-.73.13-1.43.36-2.09V7.06H2.18A11 11 0 0 0 1 12c0 1.77.43 3.45 1.18 4.94l3.66-2.85Z"
                />
                <path
                  fill="#EA4335"
        ...
        <div className="auth-field">
          ...
          >
            Поне 8 символа, главна и малка буква, цифра и
            специален символ.
          </p>
        </div>
